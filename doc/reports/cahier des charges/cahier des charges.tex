...
intéressant.\\
\begin{center}
\includegraphics[scale=0.50]{compression_fractales.jpg}
\end{center}
...
\begin{center}
\includegraphics[scale=0.50]{huffman_tree.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.50]{transformee_fourier.png}
\end{center}
...
pas.\\
\begin{center}
\includegraphics[scale=0.50]{qt.png}
\end{center}
...
\begin{center}
\includegraphics[scale=0.50]{GTK.png}
\end{center}
...
%\begin{itemize}
%	\item Première soutenance :
%	\begin{itemize}
%		\item Début de l'interface gtk
%		\item Encodage en ihy sans compression
%		\item Lecture des fichiers ihy
%		\item Site web terminé
%	\end{itemize}
%	\item Deuxième soutenance :
%	\begin{itemize}
%		\item Interface gtk terminée et début du spectrographe
%		\item Ébauches de compression avec les ondelettes
%		\item Interfaçage entre le lecteur graphique et le codec
%		\item Développement de l'API pour permettre une distribution plus large
%	\end{itemize}
%	\item Dernière soutenance :
%	\begin{itemize}
%		\item Interface gtk et spectrographe terminés
%		\item Compression avec les ondelettes terminée
%		\item API du codec terminée et distribution possible
%		\item Démonstration des tests de performances
%	\end{itemize}
%\end{itemize}
